				...
				{ 
					...
					if(rs.next())
					{
						if(rs.getString("password").equals(password))
						{
										...
										{
											%><jsp:forward	page="signin.jsp?err=Your ID is not yet confirmed"></jsp:forward><%
										}
						}
						else
						{String  subject="Invalid Login Attempt";
							...
							%><jsp:forward	page="signin.jsp?err=Invalid Password"></jsp:forward><%
						}
					}
					else
					{
							%><jsp:forward	page="signin.jsp?err=Username does not exist"></jsp:forward><%
					}       
          		}
