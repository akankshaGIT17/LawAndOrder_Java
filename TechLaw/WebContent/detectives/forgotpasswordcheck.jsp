			...
			try 
				{ 
												...
												if(rs.next())
											{
												...
												%><jsp:forward	page="forgotpassword.jsp?err=You details are sent to your ID"></jsp:forward><%
											}
												else
												{
													%><jsp:forward	page="forgotpassword.jsp?err=Username Not Found"></jsp:forward><%
												}
