...
<table border="0" align="center"><tr><td><h1><u><%=captions.getString("indianpolice")%></u></h1></td></tr></table><br /><table align="center"><tr><td><img border=1 align="middle"src="gallery/gal (12).jpg"></img></td></tr></table><br /><table border="0" align="center"><tr><td><h1><%=captions.getString("ourobjective")%></h1></td></tr></table><br /><br />
<font size=3><p align="center"><%=captions.getString("ourobjective1")%></p>
<ul><li><%=captions.getString("ourobjective2")%></li><br /><li><%=captions.getString("ourobjective3")%></li><br /><li><%=captions.getString("ourobjective4")%></li><br /><li><%=captions.getString("ourobjective5")%></li><br /><li><%=captions.getString("ourobjective6")%></li></ul>
</font>

<table border="0" align="center"><tr><td><h1><%=captions.getString("ourhistory")%></h1></td></tr></table><br /><br />
<p align=center><font size=3><%=captions.getString("ourhistory1")%></font></p>
