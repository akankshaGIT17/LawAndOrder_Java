...
function checkform()
	{	
			msg = validateField(document.COMPLAINTSTATUS.complaintid,'STRING','5','15','Complaint ID','');
			if(msg.length > 0)			
			{
				alert(msg);	
				document.COMPLAINTSTATUS.complaintid.focus();
				return false;
			}
		return true;
	}
...
<div id="templatemo_menu_wrapper">    
    <div id="templatemo_menu">
     ...
     <form method="post"     action="cstatuscheck.jsp"   id="complaint status" name="COMPLAINTSTATUS" onsubmit="return checkform()">
...
<font color="black">You can see your complaint status here.Just fill in the complaint ID that was provide you at the time of complaint registration.</font>.
<br />
<br />
<div id="login-box-name" style="margin-top:20px;"><font color="black"><b>COMPLAINT ID</b> </font></div><div id="login-box-field" style="margin-top:20px;"><input name="complaintid" id="complaintid" class="form-login" title="complaintid" value="" size="30" maxlength="2048" /></div>

<input type="hidden" value="1" name="usertype"  />
<br />
<br />
<a href="cstatuscheck.jsp"><input type="submit"  style="margin-left:90px;"  name="complainstatus" value="CHECK" /></a>
</div>
