...
{ 
//alert(str);
document.getElementById("lll").innerHTML="<img src='images/ajax-loader.gif' width='150px'>" 
	//alert(str);
xmlHttp=CreateXmlHttpObject()
...
var url="policestations2.jsp"

url=url+"?q="+str

url=url+"&sid="+Math.random()

xmlHttp.onreadystatechange=Changedx1 
...
{ 
	...
	{	 
		...
		document.getElementById("lll").innerHTML=xmlHttp.responseText 
  ...
  { 
//alert(str);
document.getElementById("polls").innerHTML="<img src='images/ajax-loader.gif' width='150px'>" 
  xmlHttp=CreateXmlHttpObject()
