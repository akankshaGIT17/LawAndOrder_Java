...
<div id="templatemo_menu_wrapper">    
    ...
    </div> <!-- end of menu --><table width="100%">
...
<font size=+1 color=red><%=captions.getString("invaliduser")%></font>
...
<div id="login-box-name"><font color="black"><%=captions.getString("pass")%></font></div><div id="login-box-field"><input name="pass" id="pass" type="password" class="form-login" title="pass" value="" size="30" maxlength="2048" /></div>
<br />
<span class="login-box-options"> <a href="#" style="margin-left:30px;"><%=captions.getString("fpass")%></a>      |<a href="#" style="margin-left:30px;"><%=captions.getString("signup")%></a></span>
<input type="hidden" value="1" name="usertype"  />
<br />
<br />
<a href="usersignincheck.jsp"><input type="submit"  style="margin-left:90px;"  name="login" value="Sign In" /></a>
