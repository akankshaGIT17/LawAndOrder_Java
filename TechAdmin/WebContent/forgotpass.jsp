	...
	<table align="center" width="150" height="215"><tr><td ><img
		...
		<div class="rain">
			<div class="border start">
				...
				<img src="images/admin.png" width="46" height="58"></img></td><td><label  for=heading><font color=white><a href="fpass.jsp">
<h3>Police Officer Forgot Password</h3></a></font></label></td></tr><tr><td></td><td><label><%
					...
					<table align="right"><tr><td><label><a href="front.jsp">Suddenly Remembered?</a></label></td><input type="hidden" value="3" name="usertype"  /></td></tr></table>
