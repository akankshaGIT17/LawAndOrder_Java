				...
				{ 
					...
					if(rs.next())
					{
						if(rs.getString("password").equals(password))
						{
										...
										{
											%><jsp:forward	page="front.jsp?err=Your ID is temporarily withdrawn."></jsp:forward><%
										}
						}
						else
						{String  subject="Invalid Login Attempt";
							...
							%><jsp:forward	page="front.jsp?err=Invalid Password"></jsp:forward><%
						}
					}
					else
					{
							%><jsp:forward	page="front.jsp?err=Username does not exist"></jsp:forward><%
					}       
          		}
